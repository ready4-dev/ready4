...
Ready4Project <- setClass("Ready4Project",
                        ...
                        prototype = list(#additions_tb = make_additions_tb(),
                                         ...
                                         dvs_tb = NULL, # get_datasets_tb()[0,],#NULL,
                                         extensions_tb = NULL, # get_cls_extensions(get_libraries_tb())[0,],# cls_extensions_tb = get_cls_extensions(get_libraries_tb()) # NULL,
                                         ...
                                         libraries_tb = NULL, # make_libraries_tb(), #get_libraries_tb() # pkg_extensions_tb = NULL
                                         #methods_chr = NULL, # print_methods - Can be derived from included Ready4Module
                                         methods_tb = NULL, # get_methods_tb(), #NULL, # print_methods
                                         modules_tb = NULL, # get_modules_tb()[0,], #### print_modules
