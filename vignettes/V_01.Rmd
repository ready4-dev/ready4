...
::: {.card-body}
::: {.card-title}
`ready4` Framework Sub-Module
:::
An informal (S3) class that describes, validates and assigns methods to slots of a `ready4` Framework Module.
:::
:::
