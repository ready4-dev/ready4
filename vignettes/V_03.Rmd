---
title: "Leverage An Object-Oriented Paradigm To Develop Modular and Transparent Computational Models Of Mental Health Systems"
output: 
  ...
  pdf_document:
    ...
    number_sections: yes
vignette: >
  %\VignetteIndexEntry{Leverage An Object-Oriented Paradigm To Develop Modular and Transparent Computational Models Of Mental Health Systems}
...
To make computational models of mental health systems more readily understood, the `ready4` framework supports use of a simple and consistent syntax that makes programs easier to read and understand. Such simplified approaches are facilitated by two other commonly noted features of OOP - polymorphism and abstraction.
