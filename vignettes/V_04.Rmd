...
Module libraries can be thematically grouped in model “sections”. In this [youth mental health example](https://readyforwhatsnext.org/docs/model/), module libraries have been grouped in to three “sections”.
