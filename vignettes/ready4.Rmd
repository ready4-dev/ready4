...
## Motivation
Health economic models should ideally be both "living" (kept up to date) and "transferable" (easy to selectively modify so they can be validly used in a new context) and applied in research that is reproducible. These goals [can be hard to achieve in practice](https://www.ready4-dev.com/docs/getting-started/motivation/).
